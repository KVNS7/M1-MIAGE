...
CSV_PATH = "Equipe3.csv"      # Chemin vers le fichier CSV à analyser
OUTPUT_3POINTS = "Equipe_3pts.csv"
OUTPUT_2POINTS = "Equipe_2pts.csv"


SCORING_SCHEMES = {
    "team_size_composition": [
        [
            "team size", "optimal team size", "ideal team size",
            "recommended team size", "team sizing", "team structure"
        ],
        [
            "cross-functional", "interdisciplinary", "multiskilled",
            "task allocation", "responsibility distribution",
            "communication", "collaboration", "coordination",
            "team dynamics", "team cohesion", "self-organizing",
            "shared leadership"
        ],
        [
            "software development", "development team", "project team",
            "agile", "scrum", "kanban", "devops", "software engineering"
        ]
    ]
}

QUERY_KEY = "team_size_composition"        # Choisis la clé du schéma à appliquer
# ---------------------------------------------------------------------------
