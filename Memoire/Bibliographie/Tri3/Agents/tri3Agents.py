...
CSV_PATH = "Agents3.csv"      # Chemin vers le fichier CSV à analyser
OUTPUT_3POINTS = "Agents_3pts.csv"
OUTPUT_2POINTS = "Agents_2pts.csv"

SCORING_SCHEMES = {
    "agents_definition": [
        # 1) synonymes et variantes de « agent »  
        ["intelligent agent", "autonomous agent", "software agent", "AI agent", 
         "cognitive agent", "learning agent", "multi-agent"],
        # 2) termes signalant une définition, un survol ou une taxonomie  
        ["definition", "concept", "overview", "framework", 
         "taxonomy", "survey", "review"],
        # 3) caractéristiques/fonctionnalités clés d’un agent  
        ["autonomy", "adaptation", "communication", "collaboration"]
    ]
}

QUERY_KEY = "agents_definition"        # Choisis la clé du schéma à appliquer
# ---------------------------------------------------------------------------
