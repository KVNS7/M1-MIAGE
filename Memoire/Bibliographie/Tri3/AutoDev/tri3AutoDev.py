...
CSV_PATH = "AutoDev3.csv"      # Chemin vers le fichier CSV à analyser
OUTPUT_3POINTS = "AutoDev_3pts.csv"
OUTPUT_2POINTS = "AutoDev_2pts.csv"


SCORING_SCHEMES = {
    "auto_dev": [
        # 1) Agents IA dédiés à la programmation
        [
            "LLM agent",
            "AI coding assistant",
            "autonomous agent",
        ...
        # 3) Projets / pipelines automatisés
        [
...
QUERY_KEY = "auto_dev"        # Choisis la clé du schéma à appliquer
# ---------------------------------------------------------------------------
